...
public class Robot extends IterativeRobot {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        autonomousCommand = new SafeAutonomousCommand();
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=AUTONOMOUS
    }
    
    public boolean hasGottenInitialLength;
    public void disabledInit() {
        NetworkTable.getTable("operatorTable").putBoolean("initialDataAvailable", false);
        SafeAutonomousCommand.setFrisbeeSideSteppingAngle(7);
    }
    public void disabledPeriodic() {
        if(!hasGottenInitialLength && NetworkTable.getTable("operatorTable").getBoolean("initialDataAvailable")) {
            ...
            SafeAutonomousCommand.setFrisbeeSideSteppingAngle(MathUtils.round(NetworkTable.getTable("operatorTable").getNumber("centerLineFrisbees")));
        }
    }
